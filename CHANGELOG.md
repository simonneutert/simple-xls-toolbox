...
- Fixed: [#9](https://github.com/simonneutert/simple-xls-toolbox/pull/9) The selection of the sheetName/sheet in multi-sheet Excel is now properly working when using the command `validate-excel`
